...
class XMLExporter:
    ...
    def to_xml(xml_string, export_path):
        ...
        for texture in textures:
            ...
            match = re.match(r"\w+/(\w*)", name) #extract e.g. the category "tree1" from "tree09/tree1"
            ...
            if match:            
                ...
                if category_name in tex_names:
                    ...
                    texture.attrib["file"] = "../examples/xml_objects/3D_Assets/"+category_name+".png"
        ...
        for mesh in meshes:
            ...
            if match:
                ...
                if category_name in mesh_names:
                    ...
                    mesh.attrib["file"] = "../examples/xml_objects/3D_Assets/"+category_name+".obj"
