...
from pita_algorithm.base.asset_placement.min_obj_distance_rule import MinObjDistanceRule
...
class RandomPlacer(AbstractPlacer):
    ...
    def add(
        ...
        '''
        min_obj_distance_rule = MinObjDistanceRule(dist=1.0, types=['Tree', 'Stone'])
        validators.append(min_obj_distance_rule)
