...
Welcome to the PITA Algorithm Documentation!
=============================================

PITA Algorithm is an automated, modular, and randomized world generator designed specifically for reinforcement learning (RL) environments that are built with MuJoCo. 
...
The PITA Algorithm is based on a "Toolbox" principle that allows for a high level of customization. 
